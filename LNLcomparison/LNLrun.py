...
Rtxtpath = "C:/temp/LNLcomp/a_Design_var1.txt"
htxtpath = "C:/temp/LNLcomp/a_Design_var2.txt"
outputpath = "C:/temp/LNLcomp/b_Objective_tip.txt"

# Command line to run ABAQUS; provide your own file name
cmdl = 'cmd /c "cd c:/temp/LNLcomp && abaqus cae noGUI=ABAQUS_MF_Test_Problem_Expensive.py"'
